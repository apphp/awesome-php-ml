...
<button type="button" class="scroll-top" id="scroll-top" aria-label="Scroll to top">^</button>
<header>
...
function updateScrollTop() {
  ...
  const hasOverflow = page.scrollHeight > window.innerHeight + 80;
  const scrolled = window.scrollY > 240;
  scrollTop.classList.toggle('is-visible', hasOverflow && scrolled);
}
